 ...
 */
router.get('/:eventId/participants/:participantId/results', ResultsController.getParticipantResults);
 ...
 */
router.get('/:eventId/results', ResultsController.getEventResults);
 ...
 */
router.post('/:eventId/participants/:participantId/results', ResultsController.submitResult);
